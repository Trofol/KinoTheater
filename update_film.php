...
<html>
	...
	<body>
        ...
        <h1 id= "title">Изменение пользователя</h1>
<form  method="POST" action="update_film.php">
    <div class= "login">
        <div class="row_text">
                    ...
                    <label for="banner">Постер:</label> <br>
                ...
                <div style="padding-top:15px;" class="row_in">
                    ...
                    <h1 class= "tsss"> Никто не узнает, что я кастыль</h1>
                    <input name="banner" id="poster" autocomplete="off" /> <br>
                    <h1 class= "tsss"> Никто не узнает, что я кастыль</h1>
...
<?php
    if (isset($_POST["name"]) or  isset($_POST["description"]) or  isset($_POST["banner"]) or  isset($_POST["poster"]) or  isset($_POST["date"]) or  isset($_POST["time"]) or  isset($_POST["language"]) or  isset($_POST["movie"]) or  isset($_POST["Grade"]) or  isset($_POST["Themes"]) or  isset($_POST["Themes2"]) or  isset($_POST["Treiler"]) or  isset($_POST["img1"]) or  isset($_POST["img2"]) or  isset($_POST["img3"]) or  isset($_POST["img4"])) {
        ...
        if(empty($upd_name)){
            $query = "Select name from kino where id = '$upd_id'";
        ...
        if(empty($description)){
            $query = "Select description from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
        ...
        if(empty($banner)){
            $query = "Select banner from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $banner = $row['banner'];
            $query = $result = $row = 0;
        ...
        if(empty($poster)){
            $query = "Select poster from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $poster = $row['poster'];
            $query = $result = $row = 0;
        ...
        if(empty($time)){
            $query = "Select time from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $time = $row['time'];
            $query = $result = $row = 0;
        ...
        if(empty($date)){
            $query = "Select date from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $date = $row['date'];
            $query = $result = $row = 0;
        ...
        if(empty($movie)){
            $query = "Select movie from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $movie = $row['movie'];
            $query = $result = $row = 0;
        ...
        if(empty($language)){
            $query = "Select language from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
        ...
        if(empty($Grade)){
            $query = "Select Grade from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $Grade = $row['Grade'];
            $query = $result = $row = 0;
        ...
        if(empty($Themes)){
            $query = "Select Themes from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $Themes = $row['Themes'];
            $query = $result = $row = 0;
        ...
        if(empty($Themes2)){
            $query = "Select Themes2 from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $Themes2 = $row['Themes2'];
            $query = $result = $row = 0;
        ...
        if(empty($Treiler)){
            $query = "Select Treiler from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $Treiler = $row['Treiler'];
            $query = $result = $row = 0;
        ...
        if(empty($img1)){
            $query = "Select img1 from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $img1 = $row['img1'];
            $query = $result = $row = 0;
        ...
        if(empty($img2)){
            $query = "Select img2 from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $img2 = $row['img2'];
            $query = $result = $row = 0;
        ...
        if(empty($img3)){
            $query = "Select img3 from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $img3 = $row['img3'];
            $query = $result = $row = 0;
        ...
        if(empty($img4)){
            $query = "Select img4 from kino where id = '$upd_id'";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result);
            $img4 = $row['img4'];
            $query = $result = $row = 0;
        ...
        $upd_sql = "UPDATE kino SET name = '$upd_name', description = '$description', banner = '$banner', poster = '$poster', time = '$time', date = '$date', movie = '$movie', language = '$language', Grade = '$Grade', Themes = '$Themes',Themes2 = '$Themes2', Treiler = '$Treiler', img1 = '$img1', img2 = '$img2', img2 = '$img2', img2 = '$img2'  WHERE id = '$upd_id'";
